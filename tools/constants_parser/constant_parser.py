...
def parse_dict() -> None:
    ...
    print(f"ram_state_settings[0]  <= 32'h00000008" + ';')
    print(f"ram_state_settings[1]  <= 32'h00000000" + ';')
    print(f"ram_state_settings[2]  <= 32'" + from_damp_to_next_clks_str + ';')
    print(f"ram_state_settings[3]  <= 32'h00000015" + ';' + '\t// A, K, DCDC')
    print(f"ram_state_settings[4]  <= 32'" + kickin_clks_str + ';')
    print(f"ram_state_settings[5]  <= 32'h00000011" + ';' + '\t// A, DCDC')
    print(f"ram_state_settings[6]  <= 32'" + on_top_clks_str + ';')
    print(f"ram_state_settings[7]  <= 32'h00000010" + ';' + '\t// DCDC')
    print(f"ram_state_settings[8]  <= 32'" + time_to_damper_clks_str + ';')
    print(f"ram_state_settings[9]  <= 32'h00000014" + ';' + '\t// Damper, DCDC')
    print(f"ram_state_settings[10] <= 32'" + from_damp_to_next_clks_str + ';')
    print(f"ram_state_settings[11] <= 32'h00000016" + ';' + '\t// B, K, DCDC')
    print(f"ram_state_settings[12] <= 32'" + kickin_clks_str + ';')
    print(f"ram_state_settings[13] <= 32'h00000012" + ';' + '\t// B, DCDC')
    print(f"ram_state_settings[14] <= 32'" + on_top_clks_str + ';')
    print(f"ram_state_settings[15] <= 32'h00000010" + ';' + '\t// DCDC')
    print(f"ram_state_settings[16] <= 32'" + time_to_damper_clks_str + ';')
    print(f"ram_state_settings[17] <= 32'h00000014" + ';' + '\t// Damper, DCDC')
    print(f"ram_state_settings[18] <= 32'h00000000" + ';')
    print(f"ram_state_settings[19] <= 32'h00000000" + ';')
    print(f"ram_state_settings[20] <= 32'h00000000" + ';')
    print(f"ram_state_settings[21] <= 32'h00000000" + ';')
    print(f"ram_state_settings[22] <= 32'h00000000" + ';')
    print(f"ram_state_settings[23] <= 32'h00000000" + ';')
    print(f"ram_state_settings[24] <= 32'h00000000" + ';')
    print(f"ram_state_settings[25] <= 32'h00000000" + ';')
    print(f"ram_state_settings[26] <= 32'h00000000" + ';')
    print(f"ram_state_settings[27] <= 32'h00000000" + ';')
    print(f"ram_state_settings[28] <= 32'h00000000" + ';')
    print(f"ram_state_settings[29] <= 32'h00000000" + ';')
    print(f"ram_state_settings[30] <= 32'h00000000" + ';')
    print(f"ram_state_settings[31] <= 32'h00000000" + ';')
    print(f"*************")
