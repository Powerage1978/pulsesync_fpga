...
set_msg_config -id {Synth 8-7129} -string "^.*?ctrl_reg.*?gatedriver.*?$" -new_severity {INFO} -regexp
set_msg_config -id {Synth 8-7129} -string "^.*?doutb.*?gatedriver.*?$" -new_severity {INFO} -regexp
