...
void Vtestrunner_svunit_pkg__03a__03asvunit_testsuite::__VnoInFunc_get_num_passing_testcases(Vtestrunner__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_passing_testcases__Vfuncrtn) {
    ...
    while (VL_LTS_III(32, unnamedblk2_1__DOT__i, this->__PVT__list_of_testcases.size())) {
        if (([&]() {
                    VL_NULL_CHECK(this->__PVT__list_of_testcases.at(unnamedblk2_1__DOT__i), "/opt/svunit/svunit-3.37.0/svunit_base/svunit_testsuite.sv", 45)
