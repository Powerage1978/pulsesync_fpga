...
VL_INLINE_OPT VlCoroutine Vtestrunner___024root___eval_initial__TOP__0____Vfork_1__0____Vfork_2__1(Vtestrunner___024root* vlSelf) {
    ...
    // Init
    VlClassRef<Vtestrunner_adder_unit_test__03a__03a__VDynScope__test0__0x5643ca983040> __Vtask___V__FORK_BEGIN_UNNAMED__0x5643ca98cc30__22____VDynScope_test0;
    IData/*31:0*/ __Vtask_get_error_count__23__Vfuncout;
    __Vtask_get_error_count__23__Vfuncout = 0;
    // Body
    __Vtask___V__FORK_BEGIN_UNNAMED__0x5643ca98cc30__22____VDynScope_test0
    ...
    if ((([&]() {
         ...
         == VL_NULL_CHECK(__Vtask___V__FORK_BEGIN_UNNAMED__0x5643ca98cc30__22____VDynScope_test0, "/app/sim/test1/./design_unit_test.sv", 105)
         ->__PVT__local_error_count)) {
        co_await VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 105)->__VnoInFunc_wait_for_error(vlSymsp);
    }
