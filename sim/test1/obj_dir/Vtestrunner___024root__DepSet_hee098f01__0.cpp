...
#include "Vtestrunner_adder_unit_test__03a__03a__VDynScope__test0__0x5627fe8e6d00__Vclpkg.h"
...
VL_INLINE_OPT VlCoroutine Vtestrunner___024root___eval_initial__TOP__0(Vtestrunner___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(([&]() {
                    VL_NULL_CHECK(vlSymsp->TOP__svunit_pkg._filter, "/app/sim/test1/./design_unit_test.sv", 82)
        ...
        vlSelf->__Vtask_run__11__test0__DOT____VDynScope_test0
            = VL_NEW(Vtestrunner_adder_unit_test__03a__03a__VDynScope__test0__0x5627fe8e6d00, vlSymsp);
        __Vtask_run__11__test0__DOT___testName = std::string{"test0"};
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 82)->__VnoInFunc_get_error_count(vlSymsp, __Vtask_get_error_count__14__Vfuncout);
        VL_NULL_CHECK(vlSelf->__Vtask_run__11__test0__DOT____VDynScope_test0, "/app/sim/test1/./design_unit_test.sv", 82)->__PVT__local_error_count
        ...
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 82)->__VnoInFunc_add_junit_test_case(vlSymsp,
                                                                                std::string{"test0"});
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 82)->__VnoInFunc_start(vlSymsp);
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 46)->__VnoInFunc_setup(vlSymsp);
        ...
        co_await vlSelf->__Vfork_1__sync.join(nullptr,
                                              ...
                                              82);
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 87)->__VnoInFunc_stop(vlSymsp);
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 61)->__VnoInFunc_teardown(vlSymsp);
        if ((([&]() {
                        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 87)
              ->__VnoInFunc_get_error_count(vlSymsp, __Vtask_get_error_count__28__Vfuncout);
                    }(), __Vtask_get_error_count__28__Vfuncout)
             == VL_NULL_CHECK(vlSelf->__Vtask_run__11__test0__DOT____VDynScope_test0, "/app/sim/test1/./design_unit_test.sv", 87)
        ...
        VL_NULL_CHECK(vlSymsp->TOP__testrunner__DOT_____05Fts__DOT__adder_ut.svunit_ut, "/app/sim/test1/./design_unit_test.sv", 87)->__VnoInFunc_update_exit_status(vlSymsp);
    }
